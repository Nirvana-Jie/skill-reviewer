...
const chineseMessages: Record<MessageKey, string> = {
  ...
  displayedEvidenceNodes: "显示 {visible} / {total} 个证据节点",
  ...
  changedRuntimeFileTree: "发生变更的运行时文件目录",
...
const valueLabels: Record<string, string> = {
  ...
  baseline: "基线",
  "native-agent": "原生 Agent 执行",
  "lead-agent-dispatch": "主 Agent 分发",
  "trusted-orchestrator": "可信编排器隔离",
  "orchestrator-default": "编排器默认策略",
  "local/trusted": "本地可信锚点",
  file_exists: "文件存在",
  text_contains: "包含必需文本",
  text_matches: "匹配预期表达",
  text_not_contains: "不含禁止文本",
  semantic_pair: "成对语义盲评",
  continue: "连续",
  reset: "重置",
  added: "新增",
  removed: "删除",
